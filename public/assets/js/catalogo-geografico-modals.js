/**
 * Modales AJAX — catálogo geográfico (estados por país)
 */
(function ($) {
    'use strict';
    ...
    $(document).on('click', '.btn-modal-estado', function () {
        loadModal($(this).data('url'), $(this).data('title'));
    });

    $(document).on('submit', '#appModalBody form[data-ajax-form="estado"]', function (e) {
        e.preventDefault();
        submitAjaxForm($(this));
    });
